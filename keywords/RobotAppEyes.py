...
class RobotAppEyes:
    ...
    *Using Selectors*
    ...
    def open_eyes_session(self, url, appname, testname, apikey, width=None,
                          ...
                          matchlevel=None, includeEyesLog=False, httpDebugLog=False, baseline_name=None,
                          save_new_tests=True):
        """
        ...
        if baseline_name is not None:
            eyes.baseline_name = testname
        if save_new_tests is True:
            eyes.save_new_tests = True
        if save_new_tests is False:
            eyes.save_new_tests = False

        # eyes.save_failed_tests = True
